...
class PanicEnv(Simulator):
    ...
    def init_wall(self, inner_width, inner_width2, inner_height, inner_height2):
        wall = []
        wall.append(Vector2(inner_width, inner_height))
        wall.append(Vector2(inner_width2, inner_height))
        wall.append(Vector2(inner_width2, inner_height2))
        wall.append(Vector2(inner_width, inner_height2))
        return wall

    def init_classroom(self,wall_width,  another_exit_width, origin_eixt_width, half_inner_width, half_inner_height):
        half_left_exit_width = another_exit_width / 2.0  # 4
        half_bottom_exit_width = origin_eixt_width / 2.0  # 4
        half_half_inner_width = half_inner_width / 2  # 20
        half_half_inner_height = half_inner_height / 2  # 20
        # 教室1
        wall1 = []
        wall2 = []
        wall3 = []
        ...
        wall20 = []
        # 教室1
        wall1 = self.init_wall(-half_half_inner_width - wall_width, -half_half_inner_width, wall_width,
                               half_half_inner_height)
        self.walls.append(wall1)
        wall2 = self.init_wall(- wall_width, 0, wall_width, half_half_inner_height)
        self.walls.append(wall2)
        wall3 = self.init_wall(-half_half_inner_width - wall_width, 0, 0, wall_width)
        self.walls.append(wall3)
        wall4 = self.init_wall(-half_half_inner_width - wall_width, -half_half_inner_width / 2 - half_left_exit_width,
                                half_half_inner_height, half_half_inner_height + wall_width)
        self.walls.append(wall4)
        wall5 = self.init_wall(-half_half_inner_width / 2 + half_left_exit_width, 0, half_half_inner_height,
                                half_half_inner_height + wall_width)
        self.walls.append(wall5)
        # 教室2
        wall6 = self.init_wall(0, wall_width, wall_width,
                                half_half_inner_height)
        self.walls.append(wall6)
        wall7 = self.init_wall(half_half_inner_width, half_half_inner_width + wall_width, wall_width,
                                half_half_inner_height)
        self.walls.append(wall7)
        wall8 = self.init_wall(0, half_half_inner_width + wall_width, 0, wall_width)
        self.walls.append(wall8)
        wall9 = self.init_wall(0, half_half_inner_width / 2 - half_left_exit_width,
                                half_half_inner_height, half_half_inner_height + wall_width)
        self.walls.append(wall9)
        wall10 = self.init_wall(half_half_inner_width / 2 + half_left_exit_width, half_half_inner_width + wall_width,
                                half_half_inner_height,
                                half_half_inner_height + wall_width)
        self.walls.append(wall10)
        # 教室3
        wall11 = self.init_wall(-half_half_inner_width - wall_width, -half_half_inner_width, -half_half_inner_height,
                                -wall_width)
        self.walls.append(wall11)
        wall12 = self.init_wall(- wall_width, 0, -half_half_inner_height, -wall_width)
        self.walls.append(wall12)
        wall13 = self.init_wall(-half_half_inner_width - wall_width, 0, -wall_width, 0)
        self.walls.append(wall13)
        wall14 = self.init_wall(-half_half_inner_width - wall_width, -half_half_inner_width / 2 - half_left_exit_width,
                                -half_half_inner_height - wall_width, -half_half_inner_height)
        self.walls.append(wall14)
        wall15 = self.init_wall(-half_half_inner_width / 2 + half_left_exit_width, 0,
                                -half_half_inner_height - wall_width,
                                -half_half_inner_height)
        self.walls.append(wall15)

        # 教室4
        wall16 = self.init_wall(0, wall_width, -half_half_inner_height,
                                -wall_width)
        self.walls.append(wall16)
        wall17 = self.init_wall(half_half_inner_width, half_half_inner_width + wall_width, -half_half_inner_height,
                                -wall_width)
        self.walls.append(wall17)
        wall18 = self.init_wall(0, half_half_inner_width + wall_width, -wall_width, 0)
        self.walls.append(wall18)
        wall19 = self.init_wall(0, half_half_inner_width / 2 - half_left_exit_width,
                                -half_half_inner_height - wall_width, -half_half_inner_height)
        self.walls.append(wall19)
        wall20 = self.init_wall(half_half_inner_width / 2 + half_left_exit_width, half_half_inner_width + wall_width,
                                -half_half_inner_height - wall_width,
                                -half_half_inner_height)
        self.walls.append(wall20)
        self.add_obstacle(wall1)
        ...
        self.add_obstacle(wall5)
        self.add_obstacle(wall6)
        self.add_obstacle(wall7)
        self.add_obstacle(wall8)
        self.add_obstacle(wall9)
        self.add_obstacle(wall10)
        self.add_obstacle(wall11)
        self.add_obstacle(wall12)
        self.add_obstacle(wall13)
        self.add_obstacle(wall14)
        self.add_obstacle(wall15)
        self.add_obstacle(wall16)
        self.add_obstacle(wall17)
        self.add_obstacle(wall18)
        self.add_obstacle(wall19)
        self.add_obstacle(wall20)
    ...
    def init_two_exit_room(self, num_agents, width_=100, height_=100, load_agents=True, read_agents=False):
        ...
        self.add_obstacle(wall5)
        self.add_obstacle(wall6)
        self.init_classroom(wall_width, another_exit_width, origin_eixt_width, half_inner_width, half_inner_height)
        self.process_obstacles()
    ...
    def check_pos(self, coord):
        while ((coord[0] < 5 and coord[0] > -5) or (coord[0] < -18 and coord[0] > -25) or (
                coord[0] < 25 and coord[0] > 18)) \
                or ((coord[1] < 5 and coord[1] > -5) or (coord[1] < -18 and coord[1] > -25) or (
                coord[1] < 25 and coord[1] > 18)):
            return True
        return False
